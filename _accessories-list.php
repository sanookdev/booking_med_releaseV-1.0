<?
    ...
    $sql = "SELECT * FROM category WHERE type = 'accessories' ORDER BY category_id DESC LIMIT 1";
    ...
    $sql = "SELECT * FROM category WHERE type = 'accessories' ORDER BY category_id DESC";
    $result = $conn->query($sql);
?>
<!doctype html>
<html lang="en">
...
<body>
    ...
    <div class="container-fluid">
        <div class="row mt-3">
            ...
            <div class="col-lg-10 col-md-10">
                        ...
                        <tr>
                            ...
                            <td>
                                <button type="button" name="delete" class="btn btn-sm btn-block btn-danger delete_data"
                                    id="<?= $row['category_id']; ?>"><i class="fa fa-remove"
                ...
                <button class="btn btn-success pull-right" href="#" data-toggle="modal" data-target="#add_acs">
                    <i class="fa fa-plus mr-2" aria-hidden="true"></i>เพิ่มอุปกรณ์
                </button>
            </div>
        </div>
    </div>
    ...
    <!-- Add Job Modal -->
    <? include "event/addAcs.php";?>

    <!-- Edit Job Detaisl -->
    <? include "event/editAcs.php";?>
    ...
    $(document).ready(function() {
        ...
        $('#details_page').html('จัดการอุปกรณ์');
        ...
        $(document).on('click', '.delete_data', function() {
            var id = $(this).attr("id");
            var where = "category_id=" + id + " AND type = 'accessories'";
            var table = "category";
            console.log(where);
            console.log(table);
            if (id != '') {
        ...
        $('#form_edit').on("submit", function(event) {
            ...
            table = "category";
            where = "category_id=" + id + " AND type = 'accessories'";
            $.ajax({
                url: "update.php",
                method: "POST",
                data: {
